...
const statusMap = {
  ...
  active: { label: 'В работе', color: 'bg-green-100 text-green-800' },
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow overflow-hidden">
        <div className="p-4">
          <div className="flex justify-between items-start mb-2">
            <h3 className="font-medium text-gray-900 text-lg line-clamp-1">{title || 'Проект без названия'}</h3>
          ...
          <div className="text-sm text-gray-500 mb-4">
            <div className="line-clamp-1">{address || 'Адрес не указан'}</div>
          </div>
