...
### 2.1 Создайте пароль приложения

1. Зайдите на https://id.yandex.ru/security/app-passwords
2. Нажмите **"Создать пароль приложения"**
3. Выберите **"Почта"** → **"n8n"**
4. Скопируйте сгенерированный пароль (например: `abcd efgh ijkl mnop`)
...
4. Заполните:
   ...
   - **Port**: `465`
   - **SSL/TLS**: `Yes`
   - **User**: `noreply@stella-spb.ru` (или ваш email)
   - **Password**: `[пароль из п.2.1]`
5. Нажмите **"Create"**
...
1. Добавьте SPF запись для домена (см. docs/dns-setup.md)
2. Настройте DKIM в Яндексе
3. Используйте корпоративную почту вместо noreply
